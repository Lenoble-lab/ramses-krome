           ...
           ! Compute final fluxes
            DO l = 1, ngrid
               ...
               if(iriemann2d==5)then
                  ...
                  calfvenL=max(abs(ALR)/sqrt(max(rstarLRx,smallc))      &
                       &       ,abs(AstarLR)/sqrt(max(rstarLR,smallc))  &
                       &       ,abs(ALL)/sqrt(max(rstarLLx,smallc))     &
                       &       ,abs(AstarLL)/sqrt(max(rstarLL,smallc)), smallc)

                  calfvenR=max(abs(ARR)/sqrt(max(rstarRRx,smallc))      &
                       &       ,abs(AstarRR)/sqrt(max(rstarRR,smallc))  &
                       &       ,abs(ARL)/sqrt(max(rstarRLx,smallc))     &
                       &       ,abs(AstarRL)/sqrt(max(rstarRL,smallc)), smallc)
                  
                  calfvenB=max(abs(BLL)/sqrt(max(rstarLLy,smallc))      &
                       &       ,abs(BstarLL)/sqrt(max(rstarLL,smallc))  &
                       &       ,abs(BRL)/sqrt(max(rstarRLy,smallc))     &
                       &       ,abs(BstarRL)/sqrt(max(rstarRL,smallc)), smallc)
                  
                  calfvenT=max(abs(BLR)/sqrt(max(rstarLRy,smallc)) &
                       &       ,abs(BstarLR)/sqrt(max(rstarLR,smallc)) &
                       &       ,abs(BRR)/sqrt(max(rstarRRy,smallc))    &
                       &       ,abs(BstarRR)/sqrt(max(rstarRR,smallc)),smallc)
